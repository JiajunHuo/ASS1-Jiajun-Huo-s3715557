...
//Brush image
function preload(){
  img = loadImage('Jiajun_Huo_portrait.JPG');
...
//mouse press change daytime & nighttime
function mousePressed() {
  on = !on;
}
//nighttime snowing
function drawStars() {
  const acc = map(mouseX, 0, width, 0.005, 0.2);//Variable of acceleration
...
class Star {
  constructor(x, y) {
    ...
    this.ang = atan2(y + width, x + height);//change the direction of snow
  }
